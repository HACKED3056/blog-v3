...
const service = computed(() => ([
	...
	{ label: '图片存储', value: () => [h('img', { src: 'https://www.cnblogs.com/images/logo.svg?v=2SMrXdIvlZwVoB1akyXm38WIKuTHVqvGD0CweV-B6cY', alt: '', style: 'height:1.2em;vertical-align:sub' }), ' 博客园'] },
